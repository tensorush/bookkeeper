...
func (server *Server) UpdateUser(ctx context.Context, req *protogen.UpdateUserRequest) (*protogen.UpdateUserResponse, error) {
	...
	rsp := &protogen.UpdateUserResponse{
		User: convertUser(user),
	}
	return rsp, nil
}

func validateUpdateUserRequest(req *protogen.UpdateUserRequest) (violations []*errdetails.BadRequest_FieldViolation) {
