...
func TestCreateUserAPI(t *testing.T) {
	...
	testCases := []struct {
		name          string
		req           *protogen.CreateUserRequest
		buildStubs    func(store *mockdb.MockStore, taskDistributor *mockwk.MockTaskDistributor)
		checkResponse func(t *testing.T, res *protogen.CreateUserResponse, err error)
	}{
		{
			name: "OK",
			req: &protogen.CreateUserRequest{
